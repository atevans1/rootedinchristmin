...
export default function AdminLoginPage() { return <main id="main-content" className="admin-login-page"><div className="admin-login-card"><p className="eyebrow">Private administration</p><h1>Welcome back.</h1><p>Sign in with your assigned ministry administrator account.</p><AdminLoginForm /><details><summary>Forgot your password?</summary><p>Request a secure password reset email.</p><PasswordResetForm /></details><p className="admin-login-note">Your owner account controls roles and client administrator access. Never share your password.</p><Link href="/" className="arrow-link">Return to public site</Link></div></main>; }
