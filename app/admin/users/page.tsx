...
export default function AdminUsersPage() {
  return <main id="main-content" className="admin-shell">
    ...
    <div className="container admin-content"><Link href="/admin" className="arrow-link">Back to dashboard <Icon name="arrow" size={18} /></Link>
      ...
      <section className="admin-form-layout"><div><p className="eyebrow">New invitation</p><h2>Client administrator</h2><p>The invitation assigns the <strong>ministry_admin</strong> role. Only the owner can manage roles.</p></div><AdminInvitationForm /></section>
